...
//    val uri1 = "https://jb-centos7:8140/production"
 ...
 val chain_1 = exec(http("filemeta")
	...
	val scn = scenario("PE38CatalogZero").exec(
		chain_0, chain_1)
