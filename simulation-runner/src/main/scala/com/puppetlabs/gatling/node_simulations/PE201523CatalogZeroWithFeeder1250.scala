...
class PE201523CatalogZeroWithFeeder1250 extends SimulationWithScenario {
	val concurrentScn = null

  val nodeNames = csv("nodes.1250.csv").circular
...
//    val uri1 = "https://perf-bl14.delivery.puppetlabs.net:8140/puppet/v3"
	...
	val chain_0 = feed(nodeNames)
      .exec(http("node")
			.get("/puppet/v3/node/${node}?environment=production&configured_environment=production&transaction_uuid=17d243cc-12ce-4e49-adfc-bdd25d799c1d&fail_on_404=true")
			.headers(headers_0))
...
val chain_1 = exec(http("filemeta")
	...
	val scn = scenario("PE201523CatalogZeroWithFeeder1250").exec(
		chain_0, chain_1)
