...
class PE201530CatalogZeroWithFeeder extends SimulationWithScenario {
...
// val uri1 = "https://perf-bl15.delivery.puppetlabs.net:8140/puppet/v3"
	...
	val chain_0 = feed(nodeNames)
      .exec(http("node")
			.get("/puppet/v3/node/${node}?environment=production&transaction_uuid=193e7c12-af9f-40ec-a474-349eb45bc2e3&fail_on_404=true")
			.headers(headers_0))
...
val chain_1 = exec(http("filemeta")
	...
	val scn = scenario("PE201530CatalogZeroWithFeeder").exec(
		chain_0, chain_1)
