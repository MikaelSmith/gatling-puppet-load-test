...
class PEBurnsideCatalogZeroLegacyCatalog extends SimulationWithScenario {
...
// 		.baseURL("https://perf-bl16.delivery.puppetlabs.net:8140")
	...
	val headers_111 = Map(
		...
		"X-Puppet-Version" -> "4.4.0",
                "Connection" -> "close")
// val uri1 = "https://perf-bl16.delivery.puppetlabs.net:8140/puppet/v3"

	val chain_0 = exec(http("node")
			.get("/puppet/v3/node/perf-bl16.delivery.puppetlabs.net?environment=production&transaction_uuid=fa749d87-dddc-4f8d-ac89-20427e4c369f&fail_on_404=true")
			.headers(headers_0))
...
val chain_1 = exec(http("filemeta")
		...
		.exec(http("report")
			.put("/puppet/v3/report/perf-bl16.delivery.puppetlabs.net?environment=production&")
			.headers(headers_111)
			.body(reportBody))
					
	val scn = scenario("PEBurnsideCatalogZeroLegacyCatalog").exec(
		chain_0, chain_1)
