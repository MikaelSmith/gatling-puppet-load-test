...
class PEBurnsideCatalogZeroStaticCatalog extends SimulationWithScenario {
...
// val uri1 = "https://perf-bl15.delivery.puppetlabs.net:8140/puppet/v3"
	...
	val scn = scenario("PEBurnsideCatalogZeroStaticCatalog")
		.exec(http("node")
			.get("/puppet/v3/node/perf-bl15.delivery.puppetlabs.net?environment=production&transaction_uuid=9221e708-f25f-4255-ad62-c03a21a270a5&fail_on_404=true")
			.headers(headers_0))
