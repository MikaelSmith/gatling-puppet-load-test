...
// val uri1 = "https://puppetserver-perf-sut57.delivery.puppetlabs.net:8140/puppet/v3"
	...
	val chain_0 = exec(http("node")
			.get("/puppet/v3/node/${node}?environment=production&transaction_uuid=a36804ec-86a3-4902-8284-55669d9d22a6&fail_on_404=true")
			.headers(headers_0))
...
val chain_1 = exec(http("filemeta")
	...
	val scn = scenario("PECouchCatalogZeroLegacyCatalog").exec(
		chain_0, chain_1)
